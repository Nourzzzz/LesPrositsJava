...
public class Level1 {
    ...
    public static void main(String[] args) {
        ...
        teachers.stream()
                ...
                .peek(teacher -> teacher.setSalary(teacher.getSalary() + 200)) // Increment salary by 200
                .max(Comparator.comparingInt(Teacher::getSalary)) // Get the teacher with the highest salary
